...
def calculate_intersection_over_union(bounding_box_lhs: np.ndarray, bounding_box_rhs: np.ndarray) -> float:
    ...
    lhs_area = (bounding_box_lhs[3] - bounding_box_lhs[0]) * \
        (bounding_box_lhs[4] - bounding_box_lhs[1])
    rhs_area = (bounding_box_rhs[3] - bounding_box_rhs[0]) * \
        (bounding_box_rhs[4] - bounding_box_rhs[1])
